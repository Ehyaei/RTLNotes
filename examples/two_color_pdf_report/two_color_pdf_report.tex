...
\definecolor{titlepageTopColor}{HTML}{47AAA2}

 % when we use titlepage-background do not set this!
\definecolor{titlepageBottomColor}{HTML}{050301}


\definecolor{titlepageTextColor}{HTML}{050301}

\definecolor{titlepageAuthorTextColor}{HTML}{47AAA2}
