...
\includegraphics[height=\bannerLogoSize\paperheight]{src/icon/RWLogo.png}
};
\node[font=\color{bannerTextColor},anchor=east,
  xshift=-1cm,yshift=-0.7cm] at (current page.north east)
  {

  \small{\textbf{ \Large\textbf{\rl{تحلیل داده بیماران کرونایی}} \\}}
  };
\end{tikzpicture}%
}
...
\begin{center}
\includegraphics[width=4cm]{src/icon/Bismillah.png}
\end{center}
