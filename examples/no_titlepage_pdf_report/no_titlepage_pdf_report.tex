...
\definecolor{pageBackgroundColor}{HTML}{f8f8f8}
...
\begin{tikzpicture}[remember picture,overlay]
\node[inner sep=0pt] at (page cs:0.8,0.85){\includegraphics[height=0.1\paperheight]{src/icon/RTLNotes.png}};
\node[inner sep=0pt] at (page cs:-0.8,0.85){\includegraphics[height=0.1\paperheight]{src/icon/RWLogo.png}};
\end{tikzpicture}
