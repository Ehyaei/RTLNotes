...
\definecolor{titlepageTextColor}{HTML}{534B3E}
...
\definecolor{bannerColor}{HTML}{F8D940}

\definecolor{bannerTextColor}{HTML}{534B3E}

\definecolor{chapterTitleColor}{HTML}{534B3E}
...
\fill[bannerColor]
  ...
  ([yshift=20pt]current page.north west|-current page text area.north west) --
  ...
  ([yshift=40pt]current page.north east|-current page text area.north east) -- cycle;

\node[inner sep=0pt] at (page cs:-0.82,0.92){
\includegraphics[height=\bannerLogoSize\paperheight]{src/icon/RTLNotes.png}
};
\node[font=\color{bannerTextColor},anchor=east,
  xshift=-1cm,yshift=-0.7cm] at (current page.north east)
  {

  \small{\textbf{ \Large\textbf{\rl{گزارش هفتگی}} \\}}
  };
\end{tikzpicture}%
}
...
\begin{center}
\vspace{0.5cm}
\huge{\uppercase{\textbf{تحلیل داده بیماران کرونایی}}}
\vspace{0.2cm}

\vspace{0.4cm}

\large{\textsf{احمدرضا احیائی}}
\vspace{0.2cm}

\large{\uppercase{اول مهرماه، ۱۴۰۰}}
\vspace{0.4cm}
